              ...
              if(email === ""){
                ...
                if(userPassword === ""){
                  ...
                  if(confirmPassword === ""){
                    ...
                    if(contactNumber === ""){
                      document.getElementById("messageContactNumber").innerHTML = "Please Enter Contact Number";
                      return false;
                    }
                      ...
                      .then(({ data }) => {
                        ...
                        if(data.signUp.error === "true"){
                          console.log("goutham is le"+data.signUp.message)
            ...
            <div className="container">
              <form className="well form-horizontal"  id="contact_form">
                <fieldset>
                  ...
                  {/* Select Basic */}
                  {/* Success message */}
                  <div className="alert alert-success" role="alert" id="success_message">Success <i className="glyphicon glyphicon-thumbs-up" /> Success!.</div>
                  {/* Button */}
                  <div className="form-group">
                    <label className="col-md-4 control-label" />
                    <div className="col-md-4"><br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" onClick={this.SignUp.bind(this)} className="btn btn-warning">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SUBMIT <span className="glyphicon glyphicon-send" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                    </div>
                  </div>
                </fieldset>
              </form>
...
export default compose(graphql(mutations.SIGNUP,{name:'signUp'}))(App);
